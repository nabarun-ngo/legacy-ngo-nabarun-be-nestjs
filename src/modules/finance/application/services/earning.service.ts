...
export class EarningService {
  ...
  async list(
    filter: BaseFilter<EarningDetailFilterDto>,
  ): Promise<PagedResult<EarningDetailDto>> {
  ...
  async update(
    ...
    const earning = await this.updateEarningUseCase.execute({
      id,
      dto,
      userId: user.profile_id!,
    });
