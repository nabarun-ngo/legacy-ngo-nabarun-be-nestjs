...
export class Project extends AggregateRoot<string> {
  ...
  public update(props: Partial<ProjectProps>): void {
    ...
    this.#targetBeneficiaryCount =
      props.targetBeneficiaryCount ?? this.#targetBeneficiaryCount;
  ...
  public updateStatus(newStatus: ProjectStatus): void {
    ...
    if (
      ...
      throw new BusinessException(
        "Can only cancel projects in PLANNING or ACTIVE status",
      );
    }
  ...
  get spentAmount(): number | undefined {
  ...
  get targetBeneficiaryCount(): number | undefined {
    return this.#targetBeneficiaryCount;
  }
  get actualBeneficiaryCount(): number | undefined {
    return this.#actualBeneficiaryCount;
  }
