...
@Injectable()
@ReportProvider()
export class ProjectReportProvider
  implements IReportProvider<{ projectId: string }>
{
  ...
  private async template(request: { projectId: string }): Promise<Buffer> {
    ...
    summarySheet
      .setCell(1, 1, "Project Closure Report", {
        font: { bold: true, size: 16 },
      })
      .setCell(3, 1, "Project Details", {
        font: { bold: true },
        fill: { type: "pattern", pattern: "solid", fgColor: "FFCC99" },
        border: allborder,
      })
      .setCell(4, 1, "Name", { border: allborder })
      .setCell(4, 2, project.name, { border: allborder })
      .setCell(5, 1, "Code", { border: allborder })
      .setCell(5, 2, project.code, { border: allborder })
      .setCell(6, 1, "Category", { border: allborder })
      .setCell(6, 2, project.category, { border: allborder })
      .setCell(7, 1, "Status", { border: allborder })
      .setCell(7, 2, project.status, { border: allborder })
      .setCell(8, 1, "Phase", { border: allborder })
      .setCell(8, 2, project.phase, { border: allborder })
      .setCell(9, 1, "Duration", { border: allborder })
      .setCell(
        9,
        2,
      ...
      .setCell(11, 1, "Financial Overview", {
        font: { bold: true },
        fill: { type: "pattern", pattern: "solid", fgColor: "FFCC99" },
        border: allborder,
      })
      .setCell(12, 1, "Total Budget", { border: allborder })
      .setCell(12, 2, project.budget || 0, {
        numFmt: "₹ #,##0.00",
        border: allborder,
      })
      .setCell(13, 1, "Total Spent", { border: allborder })
      .setCell(13, 2, project.spentAmount || 0, {
        numFmt: "₹ #,##0.00",
        border: allborder,
      })
      .setCell(14, 1, "Utilization", { border: allborder })
      .setCell(14, 2, `${project.getBudgetUtilization().toFixed(2)}%`, {
        border: allborder,
      })

      .setCell(16, 1, "Impact Summary", {
        font: { bold: true },
        fill: { type: "pattern", pattern: "solid", fgColor: "FFCC99" },
        border: allborder,
      })
      .setCell(17, 1, "Target Beneficiaries", { border: allborder })
      .setCell(17, 2, project.targetBeneficiaryCount || 0, {
        border: allborder,
      })
      .setCell(18, 1, "Actual Beneficiaries", { border: allborder })
      .setCell(18, 2, project.actualBeneficiaryCount || 0, {
        border: allborder,
      });
