...
@Injectable()
export class LinkExpenseToActivityUseCase implements IUseCase<{ activityId: string; data: LinkExpenseToActivityDto; createdBy: string }, any> {
  constructor(
  ...
  async execute(request: { activityId: string; data: LinkExpenseToActivityDto; createdBy: string }): Promise<any> {
