...
import { ReportStatus } from "../../domain/models/report.model";
...
export class ReportDetailDto {
  ...
  @ApiProperty({
    description: "The roles that can approve the report",
    isArray: true,
    type: String,
  })
  approvers?: string[];
  ...
  @ApiProperty({
    description: "The roles that can view the report",
    isArray: true,
    type: String,
  })
  viewers: string[];
  ...
  @ApiProperty({
    description: "The DMS document ID associated with the report",
  })
...
export class ReportCategoryDto {
  ...
  @ApiProperty({
    description: "The roles that can manage the report",
    isArray: true,
    type: String,
  })
  @IsString({ each: true })
  ...
  @ApiProperty({
    description: "The flag to indicate whether the report is active",
  })
  @IsBoolean()
  @IsOptional()
  isActive?: boolean;
